...
import { FaCalendarAlt, FaUsers, FaTrophy, FaFutbol, FaArrowRight, FaEnvelope } from 'react-icons/fa';
                ...
                <div className="cta-content">
                    ...
                    <div className="cta-buttons">
                        <Link to="/membership" className="cta-btn primary">
                            <FaUsers /> Become a Member <FaArrowRight />
                        </Link>
                        <Link to="/contact" className="cta-btn secondary">
                            <FaEnvelope /> Contact Us <FaArrowRight />
                        </Link>
                    </div>
                </div>
            </section>
